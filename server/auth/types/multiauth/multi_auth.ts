...
import {
  ...
  import { IOpenSearchDashboardsResponse, OpenSearchDashboardsResponse } from 'src/core/server/http/router';
  import { SecurityPluginConfigType } from '../../..';
  import { SecuritySessionCookie } from '../../../session/security_cookie';
  import { AuthenticationType } from '../authentication_type';
  import { AuthType, LOGIN_PAGE_URI } from '../../../../common';
  import { composeNextUrlQueryParam } from '../../../utils/next_url';
  import { } from '../openid/routes';
  ...
  export class MultipleAuthentication extends AuthenticationType {
    ...
    private async init() {
        let routes = new MultiAuthRoutes(
            this.router,
            this.config,
    ...
    requestIncludesAuthInfo(request: OpenSearchDashboardsRequest<unknown, unknown, unknown, any>
    ): boolean {
        //console.log("request::");
        //console.log(request);
