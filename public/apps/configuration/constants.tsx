...
export const API_ENDPOINT_STANDALONE_AUDIT = API_ENDPOINT + '/standaloneaudit';
export const API_ENDPOINT_STANDALONE_AUDIT_UPDATE = API_ENDPOINT_STANDALONE_AUDIT + '/config';
