...
export const API_ENDPOINT_INTERNAL_ACCOUNTS = API_ENDPOINT + '/internalusers/internalaccounts';
export const API_ENDPOINT_SERVICE_ACCOUNTS = API_ENDPOINT + '/internalusers/serviceaccounts';
