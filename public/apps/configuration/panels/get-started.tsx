...
export function GetStarted(props: AppDependencies) {
  return (
    <>
      <EuiFlexGroup>
        <EuiFlexItem className="landing-page-maxwidth">
          <EuiTitle size="l">
            <h1>Get started</h1>
          </EuiTitle>
          ...
          <EuiPanel paddingSize="l">
            <EuiText size="s" color="subdued">
              <p>
                ...
                users can make and the data they can access. The most basic configuration consists
                of three steps.
              </p>
            </EuiText>
          ...
          <EuiPanel paddingSize="l">
            ...
            <EuiText size="s" color="subdued">
              <p>
                Audit logs let you track user access to your Elasticsearch cluster and are useful
                for compliance purposes. If you enable this feature, Amazon Elasticsearch Service
        ...
        <EuiFlexItem className="landing-page-right-btn-maxwidth">
