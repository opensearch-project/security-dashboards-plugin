...
const basePath = Cypress.expose('basePath') || '';
const idpOrigin = new URL(Cypress.expose('idpUrl') || 'http://localhost:7000').origin;
...
before(() => {
  ...
  if (Cypress.expose('loginMethod') === 'saml_multiauth') {
