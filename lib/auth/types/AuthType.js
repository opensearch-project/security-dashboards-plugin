...
export default class AuthType {
    ...
    async init() {
        this.server.log(['error', 'security'], `The Error will occur here`);
        this.setupStorage();
        this.server.log(['error', 'security'], `Setup Storage is done`);
        ...
        this.server.log(['error', 'security'], `Setup Routes is done`);
        this.setupAuthScheme();
        this.server.log(['error', 'security'], `Setup Auth is done`);
    }
