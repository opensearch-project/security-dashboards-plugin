...
export default class ProxyCache extends AuthType {
    ...
    async authenticate(credentialHeaders, options = {}, additionalAuthHeaders = {}) {
        try {
            let user = await this.server.plugins.opendistro_security.getSecurityBackend().authenticateWithHeaders(credentialHeaders, credentialHeaders, additionalAuthHeaders);
